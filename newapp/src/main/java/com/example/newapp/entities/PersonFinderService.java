...
public class PersonFinderService implements IPersonFinderServiceLocal {
	...
	@SuppressWarnings("unchecked")
	public List<Person> findPersons(String partialName, int startIndex,
			int maxResults) {
	...
	@SuppressWarnings("unchecked")
	public List<Person> findPersons(int startIndex, int maxResults,
	...
	public long countPersons(String firstNameStartsWith,
			String lastNameStartsWith, Regions region) {
		return (Long) findPersons(true, firstNameStartsWith, lastNameStartsWith, region, 0, 0, null);
	}

	@SuppressWarnings("unchecked")
	public List<Person> findPersons(String firstNameStartsWith,
			String lastNameStartsWith, Regions region, int startIndex,
